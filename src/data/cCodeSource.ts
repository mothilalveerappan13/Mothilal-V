 ...
 *   3. Indian Rupee (INR - ₹) Currency Formatting
 * ============================================================================
 */
...
typedef struct {
    ...
    double price;            /* In Indian Rupees (INR) */
    int quantity;
    int min_threshold;
...
/**
 * Main Demo / Interactive CLI Driver
 */
int main(void) {
    ...
    printf("  Currency: Indian Rupee (INR - Rs.)\\n");
    printf("============================================================\\n\\n");
    ...
    /* Demonstrate Stock Adjustment */
    printf("--- DEMO 2: Stock Adjustment (O(1) in-place update) ---\\n");
    update_quantity(inv, "COMP-202", +10);

    /* Demonstrate Promotion to Head */
